...
namespace WebApp29Blog.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public BlogInfoesController(WebBlogDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BlogInfo != null ? 
                          ...
                          Problem("Entity set 'WebBlogDbContext.BlogInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebBlogDbContext.BlogInfo'  is null.");
            }
            var blogInfo = await _context.BlogInfo.FindAsync(id);
            if (blogInfo != null)
            {
