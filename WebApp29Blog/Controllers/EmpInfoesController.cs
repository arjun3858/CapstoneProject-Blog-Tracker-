...
namespace WebApp29Blog.Controllers
{
    public class EmpInfoesController : Controller
    {
        ...
        public EmpInfoesController(WebBlogDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EmpInfo != null ? 
                          ...
                          Problem("Entity set 'WebBlogDbContext.EmpInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebBlogDbContext.EmpInfo'  is null.");
            }
            var empInfo = await _context.EmpInfo.FindAsync(id);
            if (empInfo != null)
            {
