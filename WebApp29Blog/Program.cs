...
builder.Services.AddDbContext<WebBlogDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("WebBlogDbContext") ?? throw new InvalidOperationException("Connection string 'WebBlogDbContext' not found.")));
...
using (var scope = app.Services.CreateScope())
{
    ...
    var dbContext = services.GetRequiredService<WebBlogDbContext>();
